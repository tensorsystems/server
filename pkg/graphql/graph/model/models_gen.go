...
type AllergyEdge struct {
	Node *repository.Allergy `json:"node"`
}
...
type AppointmentEdge struct {
	Node *repository.Appointment `json:"node"`
}
...
type AppointmentStatusEdge struct {
	Node *repository.AppointmentStatus `json:"node"`
}
...
type BillingEdge struct {
	Node *repository.Billing `json:"node"`
}
...
type ChiefComplaintEdge struct {
	Node *repository.ChiefComplaint `json:"node"`
}
...
type ChiefComplaintTypeEdge struct {
	Node *repository.ChiefComplaintType `json:"node"`
}
...
type ConfirmFollowOrderInput struct {
...
type ConfirmFollowUpOrderResult struct {
	FollowUpOrder *repository.FollowUpOrder `json:"followUpOrder"`
	FollowUpID    int                       `json:"followUpId"`
	InvoiceNo     *string                   `json:"invoiceNo"`
	BillingID     *int                      `json:"billingId"`
}
...
type ConfirmReferralOrderResult struct {
	ReferralOrder *repository.ReferralOrder `json:"referralOrder"`
	ReferralID    int                       `json:"referralId"`
	InvoiceNo     *string                   `json:"invoiceNo"`
	BillingID     *int                      `json:"billingId"`
}
...
type ConfirmSurgicalOrderResult struct {
	SurgicalOrder       *repository.SurgicalOrder `json:"surgicalOrder"`
	SurgicalProcedureID int                       `json:"surgicalProcedureId"`
	InvoiceNo           string                    `json:"invoiceNo"`
}
...
type ConfirmTreatmentOrderResult struct {
	TreatmentOrder *repository.TreatmentOrder `json:"treatmentOrder"`
	TreatmentID    int                        `json:"treatmentId"`
	InvoiceNo      string                     `json:"invoiceNo"`
}
...
type DiagnosisEdge struct {
	Node *repository.Diagnosis `json:"node"`
}
...
type DiagnosticProcedureEdge struct {
	Node *repository.DiagnosticProcedure `json:"node"`
}
...
type DiagnosticProcedureOrderEdge struct {
	Node *repository.DiagnosticProcedureOrder `json:"node"`
}
...
type DiagnosticProcedureOrderUpdateInput struct {
	...
	OrderedByID    *int                                       `json:"orderedById"`
	Status         *repository.DiagnosticProcedureOrderStatus `json:"status"`
...
type DiagnosticProcedureTypeEdge struct {
	Node *repository.DiagnosticProcedureType `json:"node"`
}
...
type DiagnosticProcedureUpdateInput struct {
	...
	FarPd                       *string                               `json:"farPd"`
	NearPd                      *string                               `json:"nearPd"`
	Status                      *repository.DiagnosticProcedureStatus `json:"status"`
}
...
type ExamCategoryEdge struct {
	Node *repository.ExamCategory `json:"node"`
}
...
type ExamFindingEdge struct {
	Node *repository.ExamFinding `json:"node"`
}
...
type EyewearPrescriptionEdge struct {
	Node *repository.EyewearPrescription `json:"node"`
}
...
type EyewearPrescriptionOrderEdge struct {
	Node *repository.EyewearPrescriptionOrder `json:"node"`
}
...
type EyewearShopEdge struct {
	Node *repository.EyewearShop `json:"node"`
}
...
type FavoriteMedicationEdge struct {
	Node *repository.FavoriteMedication `json:"node"`
}
...
type FileEdge struct {
	Node *repository.File `json:"node"`
}
...
type FollowUpEdge struct {
	Node *repository.FollowUp `json:"node"`
}
...
type FollowUpInput struct {
	FollowUpOrderID int                       `json:"followUpOrderId"`
	PatientChartID  int                       `json:"patientChartId"`
	Status          repository.FollowUpStatus `json:"status"`
}
...
type FollowUpOrderEdge struct {
	Node *repository.FollowUpOrder `json:"node"`
}
...
type HpiComponentEdge struct {
	Node *repository.HpiComponent `json:"node"`
}
...
type HpiComponentTypeEdge struct {
	Node *repository.HpiComponentType `json:"node"`
}
...
type LabOrderEdge struct {
	Node *repository.LabOrder `json:"node"`
}
...
type LabOrderUpdateInput struct {
	...
	UserName       *string                    `json:"userName"`
	OrderedByID    *int                       `json:"orderedById"`
	Status         *repository.LabOrderStatus `json:"status"`
	OrderNote      *string                    `json:"orderNote"`
	ReceptionNote  *string                    `json:"receptionNote"`
}
...
type LabTypeEdge struct {
	Node *repository.LabType `json:"node"`
}
...
type LabUpdateInput struct {
	...
	Documents                          []*FileUpload         `json:"documents"`
	Images                             []*FileUpload         `json:"images"`
	Status                             *repository.LabStatus `json:"status"`
}
...
type LifestyleTypeEdge struct {
	Node *repository.LifestyleType `json:"node"`
}
...
type MedicalPrescriptionEdge struct {
	Node *repository.MedicalPrescription `json:"node"`
}
...
type MedicalPrescriptionOrderEdge struct {
	Node *repository.MedicalPrescriptionOrder `json:"node"`
}
...
func (OrderConnection) IsConnection() {}
...
type OrderEdge struct {
	Node *repository.Order `json:"node"`
}
...
type OrderReferralInput struct {
	...
	Type           repository.ReferralType `json:"type"`
}
...
type PastIllnessTypeEdge struct {
	Node *repository.PastIllnessType `json:"node"`
}
...
type PatientChartEdge struct {
	Node *repository.PatientChart `json:"node"`
}
...
type PatientDiagnosisEdge struct {
	Node *repository.PatientDiagnosis `json:"node"`
}
...
type PatientEdge struct {
	Node *repository.Patient `json:"node"`
}
...
type PatientEncounterLimitEdge struct {
	Node *repository.PatientEncounterLimit `json:"node"`
}
...
type PatientQueueInput struct {
	...
	QueueType repository.QueueType `json:"queueType"`
}
...
type PatientQueueWithAppointment struct {
	...
	QueueName string                    `json:"queueName"`
	QueueType repository.QueueType      `json:"queueType"`
	Queue     []*repository.Appointment `json:"queue"`
}
...
type PaymentEdge struct {
	Node *repository.Payment `json:"node"`
}
...
type PaymentWaiverEdge struct {
	Node *repository.PaymentWaiver `json:"node"`
}
...
type PharmacyEdge struct {
	Node *repository.Pharmacy `json:"node"`
}
...
type PhysicalExamFindingEdge struct {
	Node *repository.PhysicalExamFinding `json:"node"`
}
...
type ProgressNote struct {
	PatientHistory *repository.PatientHistory `json:"patientHistory"`
	Appointments   []*repository.Appointment  `json:"appointments"`
}
...
type ReferralEdge struct {
	Node *repository.Referral `json:"node"`
}
...
type ReferralOrderEdge struct {
	Node *repository.ReferralOrder `json:"node"`
}
...
type ReviewOfSystemEdge struct {
	Node *repository.ReviewOfSystem `json:"node"`
}
...
type RoomEdge struct {
	Node *repository.Room `json:"node"`
}
...
type ScheduleTreatmentInput struct {
	OrderID     int       `json:"orderId"`
	CheckInTime time.Time `json:"checkInTime"`
	RoomID      int       `json:"roomId"`
	InvoiceNo   string    `json:"invoiceNo"`
...
type SimilarPatients struct {
	ByName  []*repository.Patient `json:"byName"`
	ByPhone []*repository.Patient `json:"byPhone"`
}
...
type SupplyEdge struct {
	Node *repository.Supply `json:"node"`
}
...
type SurgicalOrderEdge struct {
	Node *repository.SurgicalOrder `json:"node"`
}
...
type SurgicalProcedureEdge struct {
	Node *repository.SurgicalProcedure `json:"node"`
}
...
type SurgicalProcedureTypeEdge struct {
	Node *repository.SurgicalProcedureType `json:"node"`
}
...
type SystemEdge struct {
	Node *repository.System `json:"node"`
}
...
type SystemSymptomEdge struct {
	Node *repository.SystemSymptom `json:"node"`
}
...
type TreatmentEdge struct {
	Node *repository.Treatment `json:"node"`
}
...
type TreatmentOrderEdge struct {
	Node *repository.TreatmentOrder `json:"node"`
}
...
type TreatmentTypeEdge struct {
	Node *repository.TreatmentType `json:"node"`
}
...
type UserEdge struct {
	Node *repository.User `json:"node"`
}
...
type UserTypeEdge struct {
	Node *repository.UserType `json:"node"`
}
...
type VisitTypeEdge struct {
	Node *repository.VisitType `json:"node"`
}
